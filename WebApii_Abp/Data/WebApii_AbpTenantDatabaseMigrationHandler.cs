...
public class WebApii_AbpTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<WebApii_AbpTenantDatabaseMigrationHandler> _logger;

    public WebApii_AbpTenantDatabaseMigrationHandler(
        WebApii_AbpDbSchemaMigrator dbSchemaMigrator,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<WebApii_AbpTenantDatabaseMigrationHandler> logger)
    {
